#Projeto Calculadora Básica | https://github.com/jeanhackerdobem
...
b_1 = Button(frame_corpo, command=limpar_tela, text="C", width=11, height=2, bg=c5, fg=c4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_1.place(x=0, y=0)
b_2 = Button(frame_corpo, command = lambda: iniciar('%'), text="%", width=5, height=2, bg=c2, fg=c3, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_2.place(x=118, y=0)
b_3 = Button(frame_corpo, command = lambda: iniciar('/'), text="/", width=5, height=2, bg=c3, fg=c5, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_3.place(x=177, y=0)
...
b_11 = Button(frame_corpo, command = lambda: iniciar('-'), text="-", width=5, height=2, bg=c3, fg=c5, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_17 = Button(frame_corpo, command = lambda: iniciar('.'), text=".", width=5, height=2, bg=c2, fg=c3, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
